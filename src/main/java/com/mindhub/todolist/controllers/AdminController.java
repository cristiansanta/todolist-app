...
public class AdminController {
    ...
    @Operation(summary = "Promote user to admin", description = "Promotes a user to admin role. Requires ADMIN role.")
    ...
    @Operation(summary = "Demote admin to user", description = "Demotes an admin to user role. Requires ADMIN role.")
